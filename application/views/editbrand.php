<!-- /header -->
 ...
 <?php if (!empty($Loginid)){ ?>
   <?php foreach($editbrand as $row){} ?>
   <div class="layout-content">
        <div class="layout-content-body">
          <div class="title-bar">

            <h1 class="title-bar-title">
                <span class="d-ib">EDIT BRAND</span>
            ...
            <div class="row gutter-xs" style="margin-top: 30px">
                ...
                <form action="<?php echo base_url('Brand/updateBrand/').$row['brand_id'] ?>" method="post" class="form form-horizontal" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6"><input id="brandname" name="brandname" value="<?php echo $row['brand_name']; ?>" class="form-control" type="text" placeholder="Enter Brand Name"></div>
                    </div><br/>
