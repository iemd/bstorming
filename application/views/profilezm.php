                 ...
                 <div class="col-sm-6">
                     <form action="" method="post">
                         <div class="row"> <label class="col-sm-2"><b>Full Name :</b></label><div class="col-sm-10">
                             <input type="text" class="form-control" name="name" value="<?php echo $zm['name']; ?>" readonly/>
                         </div></div><br/>
                         <div class="row">
                             <label class="col-sm-2"><b>Mobile No. :</b></label><div class="col-sm-10">
                             <input type="text" class="form-control" name="mobile"  value="<?php echo $zm['mobile']; ?>"/>
                         </div>
                         </div><br/>
                         <div class="row">
                              <label class="col-sm-2"><b>Employee ID :</b></label><div class="col-sm-10">
                            <input type="text" class="form-control" name="employeeid" value="<?php echo $zm['ID']; ?>" readonly/>
                         </div>
                         </div><br/>
                         <div class="row">
                            <label class="col-sm-2"><b>Email :</b></label><div class="col-sm-10">
                           <input type="email" class="form-control" name="email" value="<?php echo $zm['username']; ?>" readonly/>
                         </div>
                         </div><br/>
                         <div class="row">
                             <label class="col-sm-2"><b>Change Password :</b></label><div class="col-sm-10">
                           <input type="password" class="form-control" name="password" value="<?php echo $zm['password']; ?>" readonly/>
                         </div>
                         </div><br/>
