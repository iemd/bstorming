          ...
          <div class="title-bar">
            ...
            <div class="row gutter-xs" style="margin-top: 30px">
              <div class="text-center">
                ...
                <div class="col-sm-9">
                <form action="<?php echo base_url('Asm/updateAsm/') ?>" method="post" class="form form-horizontal" >
                  <!--<div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="text-right">
                            ...
                            <a href="<?php echo base_url('Asm/viewAsm'); ?>" class="btn btn-danger" type="button">Cancel</a>
                        </div>
                     </div>
                    </div>
                    </form>
