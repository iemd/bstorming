          ...
          <div class="title-bar">
            ...
            <div class="row gutter-xs" style="margin-top: 30px">
                ...
                <!--<h3 align="center">&nbsp;</h3>-->
                  <div class="table-responsive">
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php $i=1; ?>
                        <?php foreach($nhlist as $nh) { ?>
                        <tr>
                            <td><?php echo $i; ?></td>
                             <td><?php echo $nh['ID']; ?></td>
                             <td><?php echo $nh['doj']; ?></td>
                             <td><?php echo $nh['name']; ?></td>
                             <td><?php echo $nh['mobile']; ?></td>
                             ...
                             <td>
                               <a href="<?php echo base_url('Nh/editNh/').$nh['user_id']; ?>"><i class="fa fa-edit" style="font-size:18px;color:green"></i></a>&nbsp;&nbsp;
                               <a href="<?php echo base_url('Nh/deleteNh/').$nh['user_id']; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" style="font-size:18px;color:red"></i></a></td>
                            </td>
                        </tr>
                      <?php $i++; } ?>
                      </tbody>
              ...
              <div class="text-right">
                 <a href="<?php echo base_url('Employee/manageNhProfile'); ?>" class="btn btn-danger" type="button">Back</a>
              </div>
                </div>
              <div class="col-sm-1"></div>
            </div>
