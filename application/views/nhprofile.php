           ...
           <div class="layout-content-body">
             <div class="title-bar">
               ...
               <h1 class="title-bar-title">
                   <span class="d-ib">MANAGE NH PROFILE</span>
                   ...
                   <div class="col-md-10">
                       <div class="row">
                           <div class="col-md-3">
                                      ...
                                      <a type="button" href="<?php echo base_url('Nh/createNh'); ?>" class="btn btn-primary">Create NH</a>

                           </div>
                            <div class="col-md-3">

                                       <a type="button" href="<?php echo base_url('Nh/viewNh'); ?>" class="btn btn-primary">View NH Profile</a>
