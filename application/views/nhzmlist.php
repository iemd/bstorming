                      ...
                      <tbody>
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                             ...
                             <td><a href="<?php //echo base_url('Asm/selectStore/').$zm['user_id']; ?>" class="btn btn-primary btn-xs" type="button">Allocate Store</a></td>
                             <td>
                               <a href="<?php //echo base_url('Asm/editAsm/').$zm['user_id']; ?>"><i class="fa fa-edit" style="font-size:18px;color:green"></i></a>&nbsp;&nbsp;
                               <a href="<?php //echo base_url('Asm/deleteAsm/').$zm['user_id']; ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" style="font-size:18px;color:red"></i></a></td>
                            </td>
